...
window.addEventListener("scroll",()=>{ 
    ...
    if(one.offsetTop<=windoo&&two.offsetTop>windoo){
        ...
        document.querySelector(".logo").removeAttribute("id","black");
    }
        ...
        document.querySelector(".four").removeAttribute("id","active");
        document.querySelector(".five").removeAttribute("id","active");
        document.querySelector(".logo").setAttribute("id","black");
    }
    else if(three.offsetTop<=windoo&&four.offsetTop>windoo){
        document.querySelector(".three").setAttribute("id","active3");
        document.querySelector(".two").setAttribute("id","black");
        document.querySelector(".one").setAttribute("id","black");
        document.querySelector(".four").setAttribute("id","black");
        document.querySelector(".five").setAttribute("id","black");
        document.querySelector(".logo").removeAttribute("id","black");
    }
    else if(three.offsetTop<=windoo){
        document.querySelector(".four").setAttribute("id","active4");
        document.querySelector(".three").setAttribute("id","black");
        document.querySelector(".two").setAttribute("id","black");
        document.querySelector(".one").setAttribute("id","black");
        document.querySelector(".five").setAttribute("id","black");
        document.querySelector(".logo").removeAttribute("id","black");
